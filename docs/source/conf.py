# -*- coding: utf-8 -*-
#
# cl-hamcrest documentation build configuration file, created by
...
project = u'cl-hamcrest'
copyright = u'2017, Alexander Artemenko'
...
latex_documents = [
  ('index', 'cl-hamcrest.tex', u'cl-hamcrest Documentation',
...
man_pages = [
    ('index', 'cl-hamcrest', u'cl-hamcrest Documentation',
     [u'Alexander Artemenko'], 1)
]
...
texinfo_documents = [
  ('index', 'cl-hamcrest', u'cl-hamcrest Documentation',
   u'Alexander Artemenko', 'cl-hamcrest', 'One line description of project.',
   'Miscellaneous'),
]
